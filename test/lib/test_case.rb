...
Test::Unit::TestCase.class_eval do
  ...
  def initialize(*args)
    ...
    if !@@initialized and @class.class.name != 'Module' and
        [String, NilClass, TrueClass, FalseClass].index(@class).nil?
  ...
  def reset_app_state
    ApplicationState.alive = true unless ApplicationState.alive
  end
